  ...
  <table class="table" id="datatable-abona2">
    ...
    <?php
      ...
      if(isset($queries['type'])){
        $result = $wpdb->get_results("SELECT * FROM $table_name WHERE member_type = 2 AND estado_id = 1");
      }else{
        $result = $wpdb->get_results("SELECT * FROM $table_name WHERE member_type = 1 AND estado_id = 1");
      }
